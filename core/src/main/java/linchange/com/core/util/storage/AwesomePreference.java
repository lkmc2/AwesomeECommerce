package linchange.com.core.util.storage;
...
public final class AwesomePreference {
    ...
    private static final SharedPreferences PREFERENCES =
            PreferenceManager.getDefaultSharedPreferences(Awesome.getApplicationContext());
